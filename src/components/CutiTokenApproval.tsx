...
export function CutiTokenApproval() {
  ...
  useEffect(() => {
    ...
    const checkAllowance = async () => {
      try {
        ...
        // Check allowance
        console.log("[CutiTokenApproval] Checking allowance...", {
          cutiTokenAddress,
          address,
          leaveCoreAddress,
        });
  ...
  if (status === "needed" || status === "error" || status === "approving") {
    ...
    return (
      <div className="card p-4">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Approve the system to use your CutiTokens. This requires a small
              gas fee (~$0.01-$0.10).
            </p>
            <p className="text-sm text-gray-600 mt-2">
              Available:{" "}
              <span className="font-semibold">{balance} CutiToken(s)</span>
            </p>
            {errorMessage && (
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {isApproving ? "Approving..." : "Approve CutiToken"}
          </button>
