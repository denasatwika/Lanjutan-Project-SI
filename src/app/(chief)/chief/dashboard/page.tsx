    ...
    <main className="mx-auto w-full max-w-[640px] p-3 pb-24">
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h1 className="mt-1 text-2xl font-bold">Welcome, Chief 👋</h1>
          ...
          >
            See Approvals<ArrowRight className="size-3.5" />
          </Link>
        </div>
        ...
        <div className="mt-4 mb-2 grid grid-cols-3 gap-2">
          ...
          <MiniStat icon={<XCircle className="size-4" />} label="Absent" value={totalKaryawan} />
